...
<template>
  <div class="relative h-full w-200 bg-linear-to-br from-slate-50 to-slate-100">
    ...
    <div class="absolute top-6 left-6">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xl font-bold text-black">English App</span>
      </div>
    </div>
        ...
        <button
          ...
          :class="
            authType === 'login'
              ...
              : 'rounded-md px-4 py-2 text-sm font-medium text-black/70 transition-all hover:bg-white/10 hover:text-black'
          "
        >
          登录
        </button>
