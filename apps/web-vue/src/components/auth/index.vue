...
<template>
  <div v-if="isShowAuth" class="fixed inset-0 z-40 bg-black opacity-30 blur-sm filter" />
        ...
        <div class="flex flex-1 flex-col justify-center bg-white px-12 py-10">
          ...
          <div class="mt-6 text-center">
            <div class="flex items-center justify-center gap-4 text-sm text-gray-500">
              <span class="cursor-pointer transition-colors hover:text-green-600">忘记密码？</span>
