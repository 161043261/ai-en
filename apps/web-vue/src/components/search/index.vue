...
const searchContainerRef = useTemplateRef<HTMLDivElement>(metaUrl)
...
const getList = async () => {
  const res = await getWordBookListApi({ word: search.value, page: 1, pageSize: 20 })
  if (res.ok) {
